...
const setup = async (req, res) => {
  ...
  for (const filePath of settingsFiles) {
    ...
    const settingsToUpdate = {
      invenstock_app_email: email,
      invenstock_app_company_email: email,
      invenstock_app_timezone: timezone,
      invenstock_app_country: country,
      invenstocktock_app_language: language || 'en_us',
    };
